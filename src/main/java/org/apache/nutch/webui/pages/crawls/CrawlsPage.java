...
public class CrawlsPage extends AbstractBasePage<Void> {
  ...
  private static final long serialVersionUID = 457523318739331954L;
  ...
  private void populateCrawlRow(Item<Crawl> item) {
    item.add(new AjaxLink<Crawl>("edit", item.getModel()) {
      ...
      private static final long serialVersionUID = 6353914215246074114L;
    ...
    item.add(new Link<Crawl>("start", item.getModel()) {
      ...
      private static final long serialVersionUID = -6787511952915657012L;
    ...
    item.add(new Link<Crawl>("delete", item.getModel()) {
      ...
      private static final long serialVersionUID = 4333288061747728072L;
